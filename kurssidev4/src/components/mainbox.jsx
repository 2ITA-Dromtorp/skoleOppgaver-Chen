                ...
                <div className='kurs'>
                    <h1>Kursene vi tilbyr</h1>
                        <div className='tilbudtkurs'>
                            ...
                            <Link to={name = 'Kroppsøvning'} className='kursBox'>
                                ...
                                <Link to={name = 'Kroppsøvning'} className='homer'><p>klik for å les mer</p></Link>
                             </Link>

                            <Link to={name = 'Grunleggende-datakunnskap'}  className='kursBox'>
                            ...
                            <Link to={name = 'Heimkunnskap'}  className='kursBox'>
                            ...
                            <Link to={name = 'Norsk'} className='kursBox'>
